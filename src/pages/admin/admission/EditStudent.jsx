...
=======
    ...
    return (
        <div className={`${style.globalParent}`}>
            ...
            <img style={{ display: global ? "block" : "none", margin: "30px 0 0 16vw" }} className={style.photoContainer} src={filePhotoURL} ></img>
            <canvas style={{ display: global ? "none" : "block", margin: "30px 0 0 16vw" }} className={style.photoContainer} ref={photoRef} />
            ...
            <button style={{ margin: "0 0 30px 16vw" }}  onClick={() => setWebCam(true)} className={`${style.qrButton}`}>Take a photo on web cam</button>
